        ...
        <SectionReveal delay={0.15}>
          <div className="rounded-2xl border border-primary/40 bg-background p-8 md:p-14">
            ...
            <button
              ...
              className="block w-full rounded-full bg-cta px-10 py-4 text-center font-heading font-semibold text-cta-foreground transition-transform duration-300 hover:scale-[1.02] md:w-auto"
            >
